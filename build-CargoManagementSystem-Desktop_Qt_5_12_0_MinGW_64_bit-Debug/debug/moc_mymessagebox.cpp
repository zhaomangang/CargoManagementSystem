...
#include "../../CargoManagementSystem/mymessagebox.h"
...
QT_MOC_LITERAL(1, 13, 9), // "sigCharge"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4), // "user"
QT_MOC_LITERAL(4, 29, 14) // "on_yes_clicked"

    },
    "MyMessageBox\0sigCharge\0\0user\0"
    "on_yes_clicked"
};
...
void MyMessageBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigCharge((*reinterpret_cast< uint(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MyMessageBox::*)(uint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyMessageBox::sigCharge)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyMessageBox::sigCharge(uint _t1)
{
